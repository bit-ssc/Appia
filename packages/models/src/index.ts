...
export const AppiaLog = proxify<IAppiaLogModel>('IAppiaLogModel');

export const AppiaRecord = proxify<IAppiaRecordModel>('IAppiaRecordModel');
export const AppiaData = proxify<IAppiaDataModel>('IAppiaDataModel');
