...
<<<<<<< HEAD
=======
	'/v1/rooms.multiple-upload': {
		POST: (params: { file: File; rids: string; ts?: Date }) => void;
	};

>>>>>>> b71c3f38d6 (Merge branch 'prd/240827' into 'dev')
	...
	'/v1/feedback.save': {
		POST: (params: IFeedbackSaveParams) => void;
	};
};
