...
export interface IMessagesModel extends IBaseModel<IMessage> {
	...
	updateMsgDataById(_id: string, msg: any): Promise<UpdateResult>;
	updateOANotify(oaTaskId: string, msg: any): Promise<UpdateResult>;
	setSurveyStatus(_id: string, surveyStatus: any): Promise<UpdateResult>;
	getApprovalMessageByTaskId(taskId: string, options: any): Promise<IMessage | null>;
}
