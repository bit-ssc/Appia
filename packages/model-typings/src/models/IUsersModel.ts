...
export interface IUsersModel extends IBaseModel<IUser> {
	...
	findUserByTelephoneNumber(phone: any, areaCode: any, options: any): any;

	removeSendLoginSmsCodeTimeByUserId(userId: any): any;

	findUsersByTelephoneNumberAndUserId(telephoneNumber: any, userId: any): any;

	updateSendLoginSmsCodeTimeByUserId(userId: any, time: any): any;

	updateLoginSmsCodeByUserId(userId: any, code: any): any;
	...
	updateAutoReplyById(_id: string, autoReply: any): Promise<UpdateResult>;
	findAllAppiaUsers(pipeline: any): any;
	updateUsersInfo(query: any, updateInfo: any): Promise<UpdateResult>;
	queryUserInfo(query: any, options: any): any;
	countUsers(query: any): any;
}
