...
import { sendAliCloudAndroid } from './aliclound';
...
class PushClass {
	...
	sendNotificationNative(app, notification, countApn, countGcm) {
		console.log('[PUSH] sendNotificationNative:', app, notification);
	...
	async send(options) {
		...
		console.log('push send options:', options);
		...
		const notification = Object.assign(
			...
			_.pick(options, 'from', 'title', 'text', 'userId', 'rid'),
		);

		logger.debug('push.js.send, currentUser:', currentUser, 'notification:', notification);
