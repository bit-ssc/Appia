...
const RemoveUsersSecondStep = ({ onClose, onCancel, onConfirm, deletedRooms = {}, user, username, rooms = [], ...props }) => {
	...
	return (
		<GenericModal
			...
			{...props}
		>
			{t('Teams_removing__username__from_team', { username: user.name || username })}
		</GenericModal>
	);
};
