...
export const getRoomDirectives = ({
	...
	const [roomCanSetOwner, roomCanSetLeader, roomCanSetPDT, roomCanSetModerator, roomCanIgnore, roomCanBlock, roomCanMute, roomCanRemove] = [
		...((roomDirectives && [
			...
			roomDirectives.allowMemberAction(room, RoomMemberActions.SET_AS_PDT, showingUserId, userSubscription),
	...
	return { roomCanSetOwner, roomCanSetLeader, roomCanSetPDT, roomCanSetModerator, roomCanIgnore, roomCanBlock, roomCanMute, roomCanRemove };
};
