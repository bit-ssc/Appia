...
const RoomBody = (): ReactElement => {
	...
	return (
		<>
			...
			{isAnnouncementOpen && room.t !== 'd' && <Announcement announcement={room.announcement} room={room} />}
			{showWelcomeMsg ? (
			...
			<div className='main-content-flex'>
				...
				>
					<div className='messages-container-wrapper'>
						<div className='messages-container-main' style={{ background: '#ffffff' }} {...fileUploadTriggerProps}>
