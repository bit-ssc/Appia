...
const WordIcon: React.FC<ISvgProps> = ({ fontSize = 32, style }) => (
	<svg style={style} fontSize={fontSize} width='1em' height='1em' viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
		<g transform='translate(-246 -359.976)'>
			<rect width='48' height='48' rx='4' transform='translate(246 359.976)' fill='#1276e9' />
			<g transform='translate(257 363.976)'>
